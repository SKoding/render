...
class Administration(models.Model):
    ...
    id_4 = models.FloatField(blank=True, null=True)
    name_4 = models.CharField(max_length=100, blank=True, null=True)
    varname_4 = models.CharField(max_length=100, blank=True, null=True)
    type_4 = models.CharField(max_length=35, blank=True, null=True)
    engtype_4 = models.CharField(max_length=35, blank=True, null=True)
...
class Chief(models.Model):
    natid = models.IntegerField(db_column='natId', primary_key=True)  # Field name made lowercase.
...
class TreeNurseryData(models.Model):
    gid = models.AutoField(primary_key=True)
...
class Treespecies(models.Model):
    ...
    count_field = models.IntegerField(db_column='count_', blank=True, null=True)  # Field renamed because it ended with '_'.
    soiltextur = models.CharField(max_length=33, blank=True, null=True)
    soiltext = models.SmallIntegerField(blank=True, null=True)
    elevation = models.CharField(max_length=13, blank=True, null=True)
    rainfallto = models.CharField(max_length=10, blank=True, null=True)
    aez = models.CharField(max_length=8, blank=True, null=True)
    acz = models.CharField(max_length=21, blank=True, null=True)
    species = models.CharField(max_length=147, blank=True, null=True)
    globalid = models.CharField(max_length=36, blank=True, null=True)
    shape_are = models.DecimalField(db_column='shape__are', max_digits=65535, decimal_places=65535, blank=True, null=True)  # Field renamed because it contained more than one '_' in a row.
    shape_len = models.DecimalField(db_column='shape__len', max_digits=65535, decimal_places=65535, blank=True, null=True)  # Field renamed because it contained more than one '_' in a row.
    geom = models.MultiPolygonField(blank=True, null=True)
